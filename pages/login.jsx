...
const login = (props) => {
  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
      <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0 flex flex-col">
      ...
      <div className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
        ...
        <div className="relative mb-4">
          ...
          <input type="password" required minLength={8} id="password" name="password" className="w-full bg-white rounded border border-gray-300 focus:border-purple-700 focus:ring-2 focus:ring-purple-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" onChange={handlechange} />
        </div>
        <label for ='submit' >
        <button className="text-white bg-purple-700 border-0 py-2 px-8 focus:outline-none hover:bg-purple-800 rounded text-lg">Login</button>
        <input type="submit" className='hidden' />
        </label>
        <p className="text-xs text-gray-500 mt-3">Does not have an account? <Link href='/signup'><a  className="text-purple-700 hover:underline">Create one.</a></Link></p>
      </div>
    </div>
  </form>
  </div>
