...
const Home = (props) => {
  ...
  return (
    <div className='   max-w-screen mx-2 min-h-[80.5vh] ml-3'>
      {data.filter((item)=>item.publish===true).length?<section className="text-gray-600 body-font w-screen  grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10">
      {
